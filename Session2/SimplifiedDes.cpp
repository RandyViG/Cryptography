...
unsigned short int encryptDes( unsigned short int key , short int message ){
    unsigned short int subKey1, subKey2,aux,aux1,subKey[2],r1,r2;
    char auxMessage;
    Permutation *ip;
    ip = memoryAllocationDes(8);
...
unsigned short int decryptDes( unsigned short int key , short int message ){
...
Permutation * memoryAllocationDes( int len ) {
	Permutation *memory;
